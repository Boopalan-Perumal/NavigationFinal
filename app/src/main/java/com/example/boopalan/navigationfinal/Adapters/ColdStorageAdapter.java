 ...
 */
public class ColdStorageAdapter extends RecyclerView.Adapter<ColdStorageAdapter.ViewHolder>{
    ...
    private int[] images={R.mipmap.meat,R.mipmap.vegetables,R.mipmap.pharma};
       ...
       @Override
        public void onClick(final View view) {
            ...
            if (!isViewExpanded) {
                ...
                isViewExpanded = true;
                valueAnimator = ValueAnimator.ofInt(originalHeight, originalHeight + (int) (originalHeight * 1.1)); // These values in this method can be changed to expand however much you like
            } else {
    ...
    public ColdStorageAdapter(String[] myDataset,String[] myDataset1) {
        titles = myDataset;
        details = myDataset1;
    }
