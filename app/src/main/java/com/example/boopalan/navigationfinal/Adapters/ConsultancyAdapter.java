 ...
 */
public class ConsultancyAdapter extends RecyclerView.Adapter<ConsultancyAdapter.ViewHolder> {
    ...
    private int[] images={R.mipmap.businessconsulting};
    ...
    public ConsultancyAdapter(String[] myDataset,String[] myDataset1) {
        titles = myDataset;
         details = myDataset1;
    }
