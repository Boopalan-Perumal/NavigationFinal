 ...
 */
public class FoodStorageAdapter extends RecyclerView.Adapter<FoodStorageAdapter.ViewHolder> {
    ...
    private int[] images={R.mipmap.food,R.mipmap.strawberry,R.mipmap.fruit1,R.mipmap.watermelon,R.mipmap.foodscience};
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(final View view) {
                    ...
                    if (!isViewExpanded) {
                        ...
                        isViewExpanded = true;
                        valueAnimator = ValueAnimator.ofInt(originalHeight, originalHeight + (int) (originalHeight * 0.86)); // These values in this method can be changed to expand however much you like
                    } else {
    ...
    public FoodStorageAdapter(String[] myDataset,String[] myDataset1) {
        titles = myDataset;
          details = myDataset1;
    }
