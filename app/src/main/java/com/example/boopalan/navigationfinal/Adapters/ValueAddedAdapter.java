 ...
 */
public class ValueAddedAdapter extends RecyclerView.Adapter<ValueAddedAdapter.ViewHolder> {
    ...
    private int[] images={R.mipmap.qualitycontrol,R.mipmap.utilities,R.mipmap.processing,R.mipmap.material,R.mipmap.internal};
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(final View view) {
                    ...
                    if (!isViewExpanded) {
                        ...
                        isViewExpanded = true;
                        valueAnimator = ValueAnimator.ofInt(originalHeight, originalHeight + (int) (originalHeight * 0.6)); // These values in this method can be changed to expand however much you like
                    } else {
    ...
    public ValueAddedAdapter(String[] myDataset,String[] myDataset1) {
        titles = myDataset;
         details = myDataset1;
    }
