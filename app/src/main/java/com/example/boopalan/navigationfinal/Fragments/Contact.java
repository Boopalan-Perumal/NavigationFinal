...
import com.example.boopalan.navigationfinal.Adapters.ContactAdapter;
...
public class Contact extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mAdapter = new ContactAdapter(new String[]{"OFFICE LOCATION"},new String[]{"106 , 2nd Floor , Chamiers Road ,\n" +
                "Teynampet , chennai – 600018.\n" +
                "Tel: +91-44-42081816, +91-44-2435-7135.\n"});
